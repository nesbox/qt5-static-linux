...
set(Qt5Location_VERSION_STRING 5.11.0)
...
if (NOT TARGET Qt5::Location)
    ...
    set(Qt5Location_PRIVATE_INCLUDE_DIRS
        "${_qt5Location_install_prefix}/include/QtLocation/5.11.0"
        "${_qt5Location_install_prefix}/include/QtLocation/5.11.0/QtLocation"
    )
    ...
    foreach(_module_dep ${_Qt5Location_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.0 ${_Qt5Location_FIND_VERSION_EXACT}
