...
set(Qt5TextToSpeech_VERSION_STRING 5.11.0)
...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    set(Qt5TextToSpeech_PRIVATE_INCLUDE_DIRS
        "${_qt5TextToSpeech_install_prefix}/include/QtTextToSpeech/5.11.0"
        "${_qt5TextToSpeech_install_prefix}/include/QtTextToSpeech/5.11.0/QtTextToSpeech"
    )
    ...
    foreach(_module_dep ${_Qt5TextToSpeech_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.0 ${_Qt5TextToSpeech_FIND_VERSION_EXACT}
