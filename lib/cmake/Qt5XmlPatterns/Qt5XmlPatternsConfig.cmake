...
set(Qt5XmlPatterns_VERSION_STRING 5.11.0)
...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    set(Qt5XmlPatterns_PRIVATE_INCLUDE_DIRS
        "${_qt5XmlPatterns_install_prefix}/include/QtXmlPatterns/5.11.0"
        "${_qt5XmlPatterns_install_prefix}/include/QtXmlPatterns/5.11.0/QtXmlPatterns"
    )
    ...
    foreach(_module_dep ${_Qt5XmlPatterns_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.0 ${_Qt5XmlPatterns_FIND_VERSION_EXACT}
