...
set(Qt5NetworkAuth_VERSION_STRING 5.11.0)
...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.11.0"
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.11.0/QtNetworkAuth"
    )
    ...
    foreach(_module_dep ${_Qt5NetworkAuth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.0 ${_Qt5NetworkAuth_FIND_VERSION_EXACT}
