...
set(Qt5SerialBus_VERSION_STRING 5.11.0)
...
if (NOT TARGET Qt5::SerialBus)
    ...
    set(Qt5SerialBus_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialBus_install_prefix}/include/QtSerialBus/5.11.0"
        "${_qt5SerialBus_install_prefix}/include/QtSerialBus/5.11.0/QtSerialBus"
    )
    ...
    foreach(_module_dep ${_Qt5SerialBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.0 ${_Qt5SerialBus_FIND_VERSION_EXACT}
