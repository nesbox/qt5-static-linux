QT.gui_private.VERSION = 5.11.0
QT.gui_private.name = QtGui
QT.gui_private.module =
QT.gui_private.libs = $$QT_MODULE_LIB_BASE
QT.gui_private.includes = $$QT_MODULE_INCLUDE_BASE/QtGui/5.11.0 $$QT_MODULE_INCLUDE_BASE/QtGui/5.11.0/QtGui
...
QT.gui_private.enabled_features = xcb evdev freetype system-freetype fontconfig gif harfbuzz ico jpeg kms linuxfb multiprocess png tuiotouch vnc xcb-glx xlib xcb-xlib xcb-native-painting xcb-render xinput2 xkb xrender
QT.gui_private.disabled_features = accessibility-atspi-bridge angle_d3d11_qdtd direct2d directfb egl egl_x11 eglfs eglfs_brcm eglfs_egldevice eglfs_gbm eglfs_mali eglfs_openwfd eglfs_rcar eglfs_viv eglfs_viv_wl eglfs_vsp2 integrityfb integrityhid libinput libinput-axis-api mirclient mtdev system-harfbuzz system-jpeg system-png system-xcb tslib vsp2 xcb-sm xkbcommon-evdev xkbcommon-system
QMAKE_LIBS_XCB = -lxcb
